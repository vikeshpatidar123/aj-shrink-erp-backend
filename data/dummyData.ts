...
export const items: Item[] = [
  ...
  { id: "ITM007", code: "RM-INK-001", name: "YELLOW INK SOLVENT BASED", category: "Raw Material (RM)", group: "Ink", subGroup: "Solvent Inks", hsnCode: "3215", gstRate: "18%", stockUom: "Kg", active: true, ...ib, supplier: "Siegwerk India", supplierRef: "SW-YEL-SB", reOrderQty: "50", minStockQty: "20", shelfLife: "365", leadTime: "14", isRegularItem: true, colour: "Yellow", pantoneNo: "P 10-3 C", substrate: "", webWidth: "", thickness: "", shrinkage: "0", purchaseRate: "450.00", estimationRate: "460.00", remarks: "Siegwerk gravure ink" },
  { id: "ITM008", code: "RM-INK-002", name: "CYAN INK SOLVENT BASED", category: "Raw Material (RM)", group: "Ink", subGroup: "Solvent Inks", hsnCode: "3215", gstRate: "18%", stockUom: "Kg", active: true, ...ib, supplier: "Siegwerk India", supplierRef: "SW-CYN-SB", reOrderQty: "50", minStockQty: "20", shelfLife: "365", leadTime: "14", isRegularItem: true, colour: "Cyan", pantoneNo: "P 115-16 C", substrate: "", webWidth: "", thickness: "", shrinkage: "0", purchaseRate: "480.00", estimationRate: "490.00", remarks: "" },
  { id: "ITM009", code: "RM-INK-003", name: "MAGENTA INK SOLVENT BASED", category: "Raw Material (RM)", group: "Ink", subGroup: "Solvent Inks", hsnCode: "3215", gstRate: "18%", stockUom: "Kg", active: true, ...ib, supplier: "Huber Group", supplierRef: "HB-MAG-SB", reOrderQty: "50", minStockQty: "20", shelfLife: "365", leadTime: "14", colour: "Magenta", pantoneNo: "P 52-8 C", substrate: "", webWidth: "", thickness: "", shrinkage: "0", purchaseRate: "490.00", estimationRate: "500.00", remarks: "" },
  { id: "ITM010", code: "RM-INK-004", name: "BLACK INK SOLVENT BASED", category: "Raw Material (RM)", group: "Ink", subGroup: "Solvent Inks", hsnCode: "3215", gstRate: "18%", stockUom: "Kg", active: true, ...ib, supplier: "Huber Group", supplierRef: "HB-BLK-SB", reOrderQty: "100", minStockQty: "40", shelfLife: "365", leadTime: "14", isRegularItem: true, colour: "Black", pantoneNo: "Process Black C", substrate: "", webWidth: "", thickness: "", shrinkage: "0", purchaseRate: "420.00", estimationRate: "430.00", remarks: "Huber Group" },
  { id: "ITM011", code: "RM-CHM-001", name: "PU ADHESIVE DRY BOND", category: "Raw Material (RM)", group: "Solvent", subGroup: "Adhesives", hsnCode: "3506", gstRate: "18%", stockUom: "Kg", active: true, ...ib, supplier: "Henkel India", supplierRef: "HNK-PUDB-2K", purchaseUnit: "Kg", reOrderQty: "100", minStockQty: "50", shelfLife: "180", leadTime: "21", substrate: "", webWidth: "", thickness: "", shrinkage: "0", purchaseRate: "320.00", estimationRate: "330.00", remarks: "Henkel dry bond adhesive" },
...
export type GravureWorkOrder = {
  ...
  orderId: string; orderNo: string;
  customerId: string; customerName: string;
  jobName: string; substrate: string;
  width: number; noOfColors: number;
  printType: "Surface Print" | "Reverse Print" | "Combination";
  machineId: string; machineName: string;
  operatorId: string; operatorName: string;
...
export const gravureOrders: GravureOrder[] = [
  { id: "GO001", orderNo: "GRV-ORD-2024-001", date: "2024-03-06", enquiryId: "GE001", estimationId: "GEST001", customerId: "C001", customerName: "Parle Products Pvt Ltd", jobName: "Parle-G Biscuit 100g Wrap", substrate: "BOPP 20μ", structure: "BOPP 20μ + Dry Lam + CPP 30μ", width: 340, noOfColors: 8, quantity: 200000, unit: "Meter", deliveryDate: "2024-03-28", cylinderSet: "CYL-P001", totalAmount: 272000, advancePaid: 80000, status: "In Production" },
  { id: "GO002", orderNo: "GRV-ORD-2024-002", date: "2024-03-10", enquiryId: "GE002", estimationId: "GEST002", customerId: "C002", customerName: "Britannia Industries Ltd", jobName: "Britannia NutriChoice 200g", substrate: "PET 12μ", structure: "PET 12μ + Dry Lam + PE 40μ", width: 420, noOfColors: 6, quantity: 150000, unit: "Meter", deliveryDate: "2024-04-02", cylinderSet: "CYL-B001", totalAmount: 228000, advancePaid: 60000, status: "Confirmed" },
  { id: "GO003", orderNo: "GRV-ORD-2024-003", date: "2024-03-14", enquiryId: "GE005", estimationId: "", customerId: "C006", customerName: "Nestle India Ltd", jobName: "Maggi Noodles 70g Outer Wrap", substrate: "BOPP 20μ", structure: "BOPP 20μ + PE 30μ", width: 300, noOfColors: 8, quantity: 250000, unit: "Meter", deliveryDate: "2024-04-08", cylinderSet: "", totalAmount: 350000, advancePaid: 100000, status: "Confirmed" },
  { id: "GO004", orderNo: "GRV-ORD-2024-004", date: "2024-03-18", enquiryId: "GE004", estimationId: "", customerId: "C005", customerName: "Amul Dairy", jobName: "Amul Butter Shrink Sleeve", substrate: "PVC 50μ", structure: "PVC 50μ Shrink", width: 260, noOfColors: 6, quantity: 500000, unit: "Meter", deliveryDate: "2024-04-15", cylinderSet: "CYL-A001", totalAmount: 450000, advancePaid: 150000, status: "Ready" },
];

// ─── GRAVURE WORK ORDERS ──────────────────────────────────────
export const gravureWorkOrders: GravureWorkOrder[] = [
  { id: "GWO001", workOrderNo: "GRV-WO-2024-001", date: "2024-03-07", orderId: "GO001", orderNo: "GRV-ORD-2024-001", customerId: "C001", customerName: "Parle Products Pvt Ltd", jobName: "Parle-G Biscuit 100g Wrap", substrate: "BOPP 20μ", width: 340, noOfColors: 8, printType: "Surface Print", machineId: "M004", machineName: "Roto Press 1 – 8 Color", operatorId: "E004", operatorName: "Amit Tiwari", cylinderSet: "CYL-P001", inks: ["Cyan", "Magenta", "Yellow", "Black", "White", "Red", "Gold", "Silver"], quantity: 200000, unit: "Meter", plannedDate: "2024-03-18", specialInstructions: "Pantone matching mandatory. Approved sample attached.", status: "In Progress" },
  { id: "GWO002", workOrderNo: "GRV-WO-2024-002", date: "2024-03-11", orderId: "GO002", orderNo: "GRV-ORD-2024-002", customerId: "C002", customerName: "Britannia Industries Ltd", jobName: "Britannia NutriChoice 200g", substrate: "PET 12μ", width: 420, noOfColors: 6, printType: "Reverse Print", machineId: "M003", machineName: "Roto Press 4 – 6 Color", operatorId: "E005", operatorName: "Deepak Verma", cylinderSet: "CYL-B001", inks: ["Cyan", "Magenta", "Yellow", "Black", "White", "Gold"], quantity: 150000, unit: "Meter", plannedDate: "2024-03-25", specialInstructions: "Matte OPV coating required after printing.", status: "Open" },
  { id: "GWO003", workOrderNo: "GRV-WO-2024-003", date: "2024-03-15", orderId: "GO003", orderNo: "GRV-ORD-2024-003", customerId: "C006", customerName: "Nestle India Ltd", jobName: "Maggi Noodles 70g Outer Wrap", substrate: "BOPP 20μ", width: 300, noOfColors: 8, printType: "Reverse Print", machineId: "M005", machineName: "Roto Press 2 – 9 Color", operatorId: "E006", operatorName: "Santosh Rao", cylinderSet: "", inks: ["Cyan", "Magenta", "Yellow", "Black", "White", "Red", "Green", "Orange"], quantity: 250000, unit: "Meter", plannedDate: "2024-03-30", specialInstructions: "Cylinders to be sourced. Proofing required before production.", status: "On Hold" },
];
